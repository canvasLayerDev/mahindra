  ...
  return (
    <Section className="relative flex min-h-dvh items-center justify-center bg-ink-900 overflow-hidden text-center">
      ...
      <Container className="relative z-10">
        <p className="font-mono text-xs uppercase tracking-wider font-medium text-ember mb-4">(404) PAGE NOT FOUND</p>
        <h1 className="font-display text-[clamp(100px,22vw,320px)] font-extrabold text-bone leading-none select-none">
          LOST?
        </h1>
        <p className="font-body text-[clamp(20px,1.6vw,28px)] leading-tight mx-auto mb-12 text-bone-dim max-w-[45ch]">
