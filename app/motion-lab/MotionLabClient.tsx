  ...
  return (
    <div className="bg-ink-900 min-h-dvh pt-24">
      ...
      <Section noPadding className="pb-16 pt-12">
        <Container>
          <p className="t-label text-ember mb-4">(00) COMPONENT LIBRARY</p>
          <h1 className="t-h1 mb-6">MOTION LAB</h1>
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(01) REVEAL TEXT</p>
          <h2 className="t-h2 text-bone-dim mb-8">Masked Line/Word Reveal</h2>
          <div className="space-y-8 bg-ink-800 p-8 rounded-xl border border-line">
            <RevealText as="h2" split="lines" className="t-h1 text-bone">
              PURPOSE LED,
              <br />
              PERFORMANCE DRIVEN,
              <br />
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(02) SCRUB TEXT</p>
          <h2 className="t-h2 text-bone-dim mb-8">Scroll-Scrubbed Opacity</h2>
          <div className="bg-ink-800 p-8 rounded-xl border border-line">
            <ScrubText className="t-lead">
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(03) IMAGE REVEAL</p>
          <h2 className="t-h2 text-bone-dim mb-8">Clip-Path &amp; Inner Scale</h2>
          <Grid cols={2}>
            <ImageReveal
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(04) COUNTERS</p>
          <h2 className="t-h2 text-bone-dim mb-8">Odometer Count-Up</h2>
          <Grid cols={4}>
            <div className="bg-ink-800 p-6 rounded-xl border border-line">
              <p className="t-label mb-2">TURNOVER</p>
              <p className="t-h1 text-ember">
                <Counter to={30} prefix="$" suffix=" B+" />
              </p>
            </div>
            <div className="bg-ink-800 p-6 rounded-xl border border-line">
              <p className="t-label mb-2">PEOPLE</p>
              <p className="t-h1 text-bone">
                <Counter to={327} suffix="K+" />
              </p>
            </div>
            <div className="bg-ink-800 p-6 rounded-xl border border-line">
              <p className="t-label mb-2">GIRLS EDUCATED</p>
              <p className="t-h1 text-bone">
                <Counter to={940} suffix="K+" />
              </p>
            </div>
            <div className="bg-ink-800 p-6 rounded-xl border border-line">
              <p className="t-label mb-2">HERITAGE</p>
              <p className="t-h1 text-gold">
      ...
      <Section noPadding className="py-24">
        <Container>
          <p className="t-label text-ember mb-4">(05) HORIZONTAL RAIL</p>
          <h2 className="t-h2 text-bone-dim mb-8">Pinned Velocity Skew Rail</h2>
        </Container>
        <HorizontalRail>
          {Array.from({ length: 6 }, (_, i) => (
            ...
            >
              <span className="t-label text-ember">CARD 0{i + 1}</span>
              <div>
                <h3 className="t-h2 text-bone">VERTICAL {i + 1}</h3>
                <p className="t-body text-bone-dim mt-2 text-sm">
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(06) STICKY STACK</p>
          <h2 className="t-h2 text-bone-dim mb-8">Overlapping Card Scale</h2>
          <StickyStack>
            <div className="flex h-[320px] items-center justify-center rounded-2xl bg-ink-800 border border-line p-8">
              <h3 className="t-h1 text-bone">CARD 01 — BEST IN TALENT</h3>
            </div>
            <div className="flex h-[320px] items-center justify-center rounded-2xl bg-ink-700 border border-line p-8">
              <h3 className="t-h1 text-ember">CARD 02 — LEADERS IN TECH</h3>
            </div>
            <div className="flex h-[320px] items-center justify-center rounded-2xl bg-ink-800 border border-line p-8">
              <h3 className="t-h1 text-gold">CARD 03 — INCLUSIVE GROWTH</h3>
            </div>
          </StickyStack>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(07) MARQUEE</p>
          <h2 className="t-h2 text-bone-dim mb-8">Velocity Speed Ticker</h2>
        </Container>
        <Marquee speed={1.2} className="py-6 bg-ink-800 border-y border-line">
          <span className="t-h1 text-bone">PURPOSE LED</span>
          <span className="t-h1 text-ember">·</span>
          <span className="t-h1 text-bone">PERFORMANCE DRIVEN</span>
          <span className="t-h1 text-ember">·</span>
          <span className="t-h1 text-gold">FUTURE READY</span>
          <span className="t-h1 text-ember">·</span>
        </Marquee>
      </Section>
      ...
      <Section>
        <Container>
          <p className="t-label text-ember mb-4">(08) INTERACTIVE CONTROLS</p>
          <h2 className="t-h2 text-bone-dim mb-8">Magnetic &amp; Underline Controls</h2>
